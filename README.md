...
- **12 个全球指数**：A 股（上证、创业板、沪深300、中证500）、港股（恒生指数、恒生科技）、美股（纳斯达克、纳指100、标普500）、亚太（日经225、韩国KOSPI、台湾加权）
...
- **市场状态标签**：各市场指数与持仓股实时标注 LIVE / 已收盘 交易状态，LIVE 标签带呼吸脉冲动画
...
- **实时行情**：来自新浪财经，A 股为交易时段实时，美股为北京时间晚间实时。港股和亚太指数非交易时段显示前收盘价
- **市场状态**：各市场根据北京时间预设交易时段判定 LIVE / 已收盘，A 股 9:30-15:00，港股 9:30-16:00，美股 21:30-次日 4:00，日韩台各有对应时段
...
本项目由 **Claude Code**（Anthropic）与 **DeepSeek V4** 协作生成，从需求分析、架构设计到全部代码实现均由 AI 完成。
