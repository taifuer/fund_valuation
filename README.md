...
- **12 个全球指数**：A 股（上证、创业板、沪深300、中证500）、美股（纳斯达克、纳指100、纳指100科技、标普500）、亚太（恒生指数、日经225、韩国KOSPI、台湾加权）
- **美股期货参考**：纳指100、标普500 在现货闭市且对应期货活跃时，自动显示纳指100期货/标普500期货并标注“期货 LIVE”
...
- **实时行情**：来自新浪财经，A 股为交易时段实时，美股为北京时间晚间实时。港股和亚太指数非交易时段显示前收盘价；纳指100和标普500在美股现货闭市时可显示对应期货参考行情
