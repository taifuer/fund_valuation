...
聚合全球主要指数、资产、ETF、代表性公司与 QDII 基金公开数据，提供市场概览、区间表现、经营趋势和按目标日期对齐的基金估算净值。

[在线访问](https://fund.taifua.com/) · [数据与估算](./docs/DATA.md) · [部署运维](./docs/OPERATIONS.md)

## 核心能力

- **全球市场**：首页聚焦指数、资产、ETF 与汇率；覆盖 A 股、美股、港股及日韩台主要指数，现货闭市时可按规则展示活跃期货参考行情
- **走势分析**：近期视图整合涨跌幅与现值，历史区间同时展示回撤、收益回撤比和胜率，支持表头排序、点击名称或整行查看走势；历史视图提供主要指数和资产的长期走势与年度收益
- **QDII 基金**：独立基金页按需加载，按主动、指数分类，展示官方净值与历史表现；主动基金另提供待公布估值、实时参考和持仓穿透。默认指数基金统一仅采用官方净值，不参与持仓估算
