...
const UPDATES = [
  ...
  },
  {
    ...
    description: '新增代表性公司财报趋势，明确待公布估值、实时参考和已披露净值的日期口径，并更新基金季度持仓与日韩个股行情支持。',
  },
  {
    date: '2026年7月',
    title: '提升数据稳定性与使用体验',
    ...
    <main className={styles.page}>
      ...
      <div className={styles.content}>
        <section className={styles.section} aria-labelledby="about-introduction">
          ...
          <p>
            全球资产看板聚合主要市场指数、资产、ETF、代表性公司和 QDII 基金公开数据，提供市场概览、公司财报趋势、官方净值、持仓估算、长期走势、区间收益与风险指标，帮助了解不同市场、公司和基金的表现。
          </p>
          <p>
