    ...
    <main className={styles.page}>
      ...
      <div className={styles.content}>
        <section className={styles.section} aria-labelledby="about-introduction">
          ...
          <p>
            行情主要来自新浪财经、东方财富、台湾证券交易所和 Naver Finance，基金净值、资料及持仓主要来自天天基金、东方财富等公开接口。不同数据源可能存在延迟、缺失或误差；基金估算基于已披露持仓、行情与汇率计算，不代表基金公司正式净值。基金净值以基金管理人正式披露为准，所有数据仅供参考，不构成投资建议。
          </p>
