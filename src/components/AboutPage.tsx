...
const UPDATES = [
  {
    date: '2026年8月',
    title: '扩展公司财报趋势与 QDII 估算',
    description: '新增代表性科技公司财报趋势，明确待公布估值、实时参考和已披露净值的日期口径，并更新基金季度持仓与日韩个股行情支持。',
  },
  {
    date: '2026年7月',
    title: '提升数据稳定性与使用体验',
    ...
    <main className={styles.page}>
      ...
      <div className={styles.content}>
        <section className={styles.section} aria-labelledby="about-introduction">
          ...
          <p>
            全球资产看板聚合主要市场指数、资产、ETF、代表性科技公司和 QDII 基金公开数据，提供市场概览、公司财报趋势、官方净值、持仓估算、区间收益与风险指标，帮助快速了解不同市场、公司和基金的近期表现。
          </p>
          <p>
            行情主要来自新浪财经、腾讯财经、台湾证券交易所、Naver Finance 和 Coin Metrics，历史参考汇率来自欧洲中央银行；基金净值、资料及持仓主要来自天天基金、东方财富等公开接口。公司经营数据根据官方披露离线整理并随版本发布，不在访问时实时抓取。不同数据源可能存在延迟、缺失或误差；基金估算基于已披露持仓、行情与汇率计算，不代表基金公司正式净值。基金净值以基金管理人正式披露为准，所有数据仅供参考，不构成投资建议。
          </p>
