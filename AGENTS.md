...
Use `taifu <taifu@taifua.com>` as the Git author. Agent-assisted commits must include `Co-Authored-By: Codex (GPT‑6 Astra) <noreply@openai.com>` in the commit message body.
