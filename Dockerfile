...
ARG FUND_VALUATION_ENABLE_FUND_MANAGEMENT=1
ARG FUND_VALUATION_BAIDU_ANALYTICS_ID=
ARG FUND_VALUATION_NPM_REGISTRY=https://registry.npmjs.org
ENV FUND_VALUATION_ENABLE_FUND_MANAGEMENT=${FUND_VALUATION_ENABLE_FUND_MANAGEMENT} \
